...
<title>Gestion des liste des machines par salle</title>
<script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
<link href="style/style.css" rel="stylesheet" type="text/css" />
<script src="scripts/listems.js" type="text/javascript"></script>
				...
				<div class="card mb-3 mb-md-4">
					...
					<div class="card-body shadow">
						...
						<nav class="d-none d-md-block" aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Liste Machines</a></li>
								<li class="breadcrumb-item active" aria-current="page">Chercher les machines
									d'une salle</li>
							</ol>
						</nav>
						<!-- End Breadcrumb -->
